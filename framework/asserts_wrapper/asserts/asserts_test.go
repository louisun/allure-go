...
func TestAssertErrorAs_Fail(t *testing.T) {
	...
	require.Equal(t, "NewMessage: other", params[0].GetValue())
	require.Equal(t, "Target", params[1].Name)
	require.Equal(t, fmt.Sprintf("**asserts.fakeError((**asserts.fakeError)(%+v))", &err), params[1].GetValue())
...
func TestAssertImplements_Success(t *testing.T) {
	...
	require.Equal(t, fmt.Sprintf("*asserts.testInterface(%#v)", ti), params[0].GetValue())
	require.Equal(t, "Object", params[1].Name)
	require.Equal(t, fmt.Sprintf("*asserts.testStructSuc(%#v)", ts), params[1].GetValue())
...
func TestAssertIsType_Fail(t *testing.T) {
	...
	require.Equal(t, "Expected Type", params[0].Name)
	require.Equal(t, fmt.Sprintf("*asserts.testStruct(%#v)", test), params[0].GetValue())

	require.Equal(t, "Object", params[1].Name)
	require.Equal(t, fmt.Sprintf("*asserts.failTestStruct(%#v)", act), params[1].GetValue())
